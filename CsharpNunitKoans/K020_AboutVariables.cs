...
namespace TheKoans
{
	...
	public class K020_AboutVariables : KoanHelper
	{
		...
		public void ImplicitConversionUsingImplicitKeyword ()
		{
			...
			Assert.AreEqual (typeof(Int32), firstTest.GetType (), "An int and a user-defined type that can return an int walk into a bar... And their baby is a...");
			Assert.AreEqual (typeof(Int32), secondTest.GetType (), "This will show you the type is not based on the order of expression's operands, but their result.");
		}
	}
}
